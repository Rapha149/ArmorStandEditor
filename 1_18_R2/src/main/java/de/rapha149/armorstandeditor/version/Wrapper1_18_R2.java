...
public class Wrapper1_18_R2 implements VersionWrapper {
    ...
    public Optional<String> getCustomNameJson(ArmorStand armorStand) {
        return Optional.ofNullable(((CraftArmorStand) armorStand).getHandle().Z()).map(ChatSerializer::a);
    }

    @Override
    public void setCustomName(ArmorStand armorStand, String customNameJson) {
        ((CraftArmorStand) armorStand).getHandle().a(customNameJson == null ? null : ChatSerializer.a(customNameJson));
    }
    ...
    public ItemStack getArmorstandItem(ArmorStand armorStand, NamespacedKey privateKey) {
        ...
        NBTTagCompound itemNBT = nmsItem.u();
