...
public class Wrapper1_20_R3 implements VersionWrapper {
    ...
    public String getCustomNameForEdit(ArmorStand armorStand) {
        ...
        return EDIT_SERIALIZER.serialize(GSON_SERIALIZER.deserialize(ChatSerializer.a(handle.ad())));
    }
    ...
    public Component getCustomNameForDisplay(ArmorStand armorStand) {
        ...
        return GSON_SERIALIZER.deserialize(ChatSerializer.a(handle.af()));
    }
    ...
    public ItemStack getArmorstandItem(ArmorStand armorStand, NamespacedKey privateKey) {
        ...
        if (handle.ae())
            nbt.a("CustomName", ChatSerializer.a(handle.af()));
